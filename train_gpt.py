...
class GPT(nn.Module):
    ...
    def create_blockmasks(self, input_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        return build_bm(sliding_window_num_blocks), build_bm(sliding_window_num_blocks // 4), build_bm(sliding_window_num_blocks // 2)
...
class Hyperparameters:
    ...
    # optimization
    num_iterations = 600 # number of iterations to run
