...
class GPT(nn.Module):
    def __init__(self, vocab_size: int, num_layers: int, num_heads: int, head_dim: int, model_dim: int,
        ...
        self.lm_head = CastedLinear(model_dim, vocab_size, use_fp8=use_fp8, x_s=100 / 448, w_s=1.6 / 448,
                                    grad_s=0.75 / 448)
...
class Hyperparameters:
    # data
    train_files: str = "data/fineweb/fineweb100B/fineweb_train_*.bin"  # input .bin to train on
    val_files: str = "data/fineweb/fineweb100B/fineweb_val_*.bin"  # input .bin to eval validation loss on
    ...
    # optimization
    num_scheduled_iterations: int = 30000 # number of steps to complete lr and ws schedule
