...
class GPT(nn.Module):
    ...
    def create_blockmasks(self, input_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        return build_bm(sliding_window_num_blocks + (sliding_window_num_blocks//2)), build_bm(sliding_window_num_blocks // 6), build_bm(sliding_window_num_blocks // 6)
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        block_masks = [long_bm, short_bm, short_bm, short_bm, short_bm, short_bm, long_bm, short_bm, short_bm, long_bm, short_bm, short_bm, short_bm, short_bm, short_bm, long_bm]
