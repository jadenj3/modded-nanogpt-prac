...
class Hyperparameters:
    ...
    # optimization
    num_scheduled_iterations: int = 18000  # number of steps to complete lr and ws schedule
    num_extension_iterations: int = 1000  # number of steps to continue training at final lr and ws
