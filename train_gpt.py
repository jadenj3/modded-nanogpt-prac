...
class GPT(nn.Module):
    ...
    def forward(self, input_seq: Tensor, target_seq: Tensor, sliding_window_num_blocks: Tensor):
        ...
        block_masks = [long_bm, short_bm, short_bm, shorter_bm, long_bm, shorter_bm, short_bm, short_bm, long_bm, short_bm, shorter_bm, short_bm, long_bm, short_bm, shorter_bm, long_bm]
